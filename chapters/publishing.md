...
* Any other invited individuals (eg. domain team etc) would opt into acknowledgement OR opt into consortial contributorship; the latter requires meeting the four ICJME criteria above
