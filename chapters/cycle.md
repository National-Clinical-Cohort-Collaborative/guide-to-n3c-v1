...
Each COVID-positive patient is matched to roughly, 1:2 ratio, control cohort patients.
N3C defines _control cohort_ as a patient with one or more non-positive COVID lab tests.
