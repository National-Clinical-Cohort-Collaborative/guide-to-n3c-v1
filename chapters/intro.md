...
![A visual representation of disparate, non-compatible EHR databases across the United States.](images/intro/image-01-siloed.png){#fig-intro-siloed width=100%}
...
![A visual representation of N3C's data harmonization from source-CDM model, and team-based access to these data in a secure cloud-based enclave.](images/intro/image-02-harmonized.png){#fig-intro-harmonized width=100%}
...
![Summary statistics for N3C patients as of Aug, 2022. Confirmed COVID-19 patients are those with a known positive PCR or Antigen lab test, possible patients are those with likely symptomatology.](images/intro/image-03-summary-stats.png){#fig-intro-summary-stats width=100%}
