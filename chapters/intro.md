...
In recent years, the common solution to these issues have been the creation of _Common Data Models_ (CDMs).
...
Examples of such federated networks include PCORNet, i2b2, and OHDSI, each of which utilize their own common data model.
...
N3C simultaneously moderates controlled access to these data by research teams from across the country (and beyond), including from private companies, community colleges, universities, medical schools, and government entities.
